...
const PrivacyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      {/* Content */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 -mt-8">
        {/* All Sections - Unified Design */}
        <div className="space-y-8">
          {sections.map((section, index) => (
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-start gap-2">
                <CheckCircle className="h-5 w-5 text-[#874EFF] flex-shrink-0 mt-0.5" />
          ...
          {additionalSections.map((section, index) => (
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-start gap-2">
                <CheckCircle className="h-5 w-5 text-[#874EFF] flex-shrink-0 mt-0.5" />
                <span>{sections.length + index + 1}. {section.title}</span>
              </h3>
